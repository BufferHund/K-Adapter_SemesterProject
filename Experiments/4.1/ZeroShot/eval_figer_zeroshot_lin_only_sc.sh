#!/bin/bash
# EVALUATION (FIGER): Zero-shot performance of roberta-large with lin-adapter.
echo "====== EVALUATING (FIGER): ZERO-SHOT LIN-ADAPTER ======"
python examples/run_finetune_figer_adapter.py \
    ...
    --comment 'eval_figer_zeroshot_lin_only' \
    --max_seq_length=256  \
