#!/bin/bash
# EVALUATION (FIGER): Zero-shot performance of roberta-large with fac-adapter.
echo "====== EVALUATING (FIGER): ZERO-SHOT FAC-ADAPTER ======"
python examples/run_finetune_figer_adapter.py \
    ...
    --comment 'eval_figer_zeroshot_fac_only' \
    --max_seq_length=256  \
