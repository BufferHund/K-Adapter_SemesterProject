#!/bin/bash
# EVALUATION (TACRED): Zero-shot performance of roberta-large with lin-adapter.
echo "====== EVALUATING (TACRED): ZERO-SHOT LIN-ADAPTER ======"
python examples/run_finetune_TACRED_adapter.py \
    ...
    --comment 'eval_tacred_zeroshot_lin_only' \
    --max_seq_length=184  \
